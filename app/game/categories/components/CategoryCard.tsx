...
const CategoryCard = ({ id, name, completedLevelCount, maxLevelCount, stars, maxStars, image }: { id: string, name: string, completedLevelCount: number, maxLevelCount: number, stars: number, maxStars: number, image: string }) => {
    return (
        <section
        ...
        >
            ...
            <div className="flex gap-2">
                <div className="bg-[#a2bcfe] px-3 py-2 rounded-lg text-lg z-3">
                    {completedLevelCount}/{maxLevelCount}
                </div>
