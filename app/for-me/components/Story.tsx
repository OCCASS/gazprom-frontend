const Story = ({ image, title }: { image: string, title: string }) => {
    return (
        <div className="p-[2px] rounded-[16px] bg-gradient-to-r from-pink-500 to-purple-500 size-28 cursor-pointer">
            <div className="relative bg-[#f5f5f5] p-[2px] rounded-[14px] w-full h-full">
                ...
                <p className="absolute top-0 left-0 right-0 text-sm text-white p-2 leading-none">
                    {title}
                </p>
            </div>
        </div>
