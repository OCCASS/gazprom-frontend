...
export default function Home() {
    const steps = [{ selector: "#eye", text: "Нажми", description: "Эта кнопка нихуя не делает" }, { selector: "#plus", text: "Похуй", description: "Эта тоже" }, { selector: "#plus1", text: "Канец", description: "Эта в целом тоже ничего не делает" }]

    return (
        <Tour steps={steps}>
            <Layout>
                <Header>
                    <button id="eye" className="size-7 cursor-pointer rounded-full">
                ...
                <main>
                    ...
                    <section className="bg-white mx-4 p-4 rounded-2xl">
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <button className="cursor-pointer p-1 rounded-full bg-[#f5f5f5]" id="plus">
                    ...
                    <section className="grid grid-cols-8 px-4 gap-2">
                        ...
                        <div className="col-span-5 rounded-2xl bg-[#4a3d9b] p-4 min-h-32">
                            <div className="flex justify-between items-start gap-1">
                                ...
                                <button id="plus1" className="grid place-items-center bg-[#45398f] rounded-full size-4">
